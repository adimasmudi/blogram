...
export default function Navigation() {
  ...
  return (
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 fixed w-full top-0">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        >
          <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <a href="/post" className={path === "post" ? active : inActive}>
                Post
              </a>
            </li>
            <li>
              <a
                href="/notification"
                className={path === "notification" ? active : inActive}
              >
                Notification
              </a>
            </li>
